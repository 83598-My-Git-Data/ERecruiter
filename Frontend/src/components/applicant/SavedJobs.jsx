...
import { SaveJob, UnSaveJob, FetchSavedJobs, ApplyJob } from "../../services/applicantJob"
                            ...
                            <div className="row">
                                ...
                                <div className="col-2  row">
                                    <div className=" row">
                                        ...
                                        <div className="col-4 px-3 "><i class="bi bi-bookmark-check-fill h2 " onClick={() => { UnSaveJob(job.jobId) }}></i></div>
